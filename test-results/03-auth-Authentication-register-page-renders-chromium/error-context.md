...
- Name: 03-auth.spec.ts >> Authentication >> register page renders
- Location: e2e\03-auth.spec.ts:5:7
...
- paragraph: Start learning for free today
- text: First name
- img
- textbox "First name":
  - /placeholder: John
...
- button "Show password":
  - img
- paragraph: Must contain uppercase, lowercase, and a number
